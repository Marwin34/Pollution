...
addStationOK_test() ->
  ...
  {_, M1} = pollution:addStation("Monte Carlo", {55.5, 77.7}, M),
...
addValueOK_test() ->
  ExpectedValue = {monitor, #{{55.5, 77.7} => {station, "Khoroinis", {55.5, 77.7}},
    ...
    {measurement, 125}}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Khoroinis", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Khoroinis", {{2019, 5, 1}, {23, 37, 45}}, "PM10", 125, M1),
...
addValueBadArgumentError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Vizima", {55.5, 77.7}, M),
...
addValueMeasurementAlreadyExist_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Vengerberg", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Vengerberg", Date, "PM10", 105, M1),
...
removeValueSingleOK_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Aldersberg", {55.5, 77.7}, M),
  {_, M2} = pollution:addStation("Rivia", {55.6, 77.8}, M1),
  {_, M3} = pollution:addValue("Aldersberg", Date, "PM10", 105, M2),
  {_, M4} = pollution:addValue({55.6, 77.8}, Date, "PM10", 105, M3),
  {_, M5} = pollution:removeValue("Aldersberg", Date, "PM10", M4),
  {_, M6} = pollution:removeValue({55.6, 77.8}, Date, "PM10", M5),
...
removeValueBadArgumentError_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Scala", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Scala", Date, "PM10", 105, M1),
...
removeValueMeasurementDoesntExist_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Vergen", {55.5, 77.7}, M),
...
getOneValueOK_test() ->
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Rinbe", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Rinbe", Date, "PM10", 105, M1),
  {_, Val1} = pollution:getOneValue("Rinbe", Date, "PM10", M2),
...
getOneValueBadArgumentError_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Novigrad", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Novigrad", Date, "PM10", 105, M1),
...
getOneValueMeasurementDoesntExist_test() ->
  ...
  Date = {{2019, 5, 1}, {23, 37, 45}},
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Hagge", {55.5, 77.7}, M),
  {_, Val1} = pollution:getOneValue("Hagge", Date, "PM10", M1),
  ?assertEqual(ExpectedVal, Val1).

getStationMeanOK_test() ->
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Ellander", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Ellander", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Ellander", {{2019, 4, 1}, {19, 11, 10}}, "PM10", 127, M2),
  {_, Val1} = pollution:getStationMean("Ellander", "PM10", M3),
...
getStationMeanBadArgumentError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Carreas", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Carreas", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Carreas", {{2019, 4, 1}, {19, 11, 10}}, "PM10", 127, M2),
...
getStationMeanStationDoesntExistError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Maribor", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Maribor", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Maribor", {{2019, 4, 1}, {19, 11, 10}}, "PM10", 127, M2),
  {_, Val1} = pollution:getStationMean("Mayena", "PM10", M3),
  ?assertEqual(ExpectedVal, Val1).

getDailyMeanOK_test() ->
  M =  pollution:createMonitor(),
  {_, M1} = pollution:addStation("Dorian", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Dorian", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Dorian", {{2019, 5, 1}, {17, 11, 10}}, "PM10", 127, M2),
...
getDailyMeanOKNoDate_test() ->
  M =  pollution:createMonitor(),
  {_, M1} = pollution:addStation("Dorian", {55.5, 77.7}, M),
  {_, Val1} = pollution:getDailyMean({{2019, 5, 1}, {19, 11, 10}}, "PM10", M1),
...
getDailyMeanBadArgumentError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Gors Vellen", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Gors Vellen", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Gors Vellen", {{2019, 5, 1}, {17, 11, 10}}, "PM10", 127, M2),
  {_, Val1} = pollution:getDailyMean({{2019, 5, 1}, {19, 11, 10}}, pm10, M3),
  ?assertEqual(ExpectedVal, Val1).

getCorrelationOK_test() ->
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Cidaris", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Cidaris", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Cidaris", {{2019, 5, 1}, {19, 11, 10}}, "PM2,5", 127, M2),
...
getCorrelationBadArgumentError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Kerack", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Kerack", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Kerack", {{2019, 5, 1}, {19, 11, 10}}, "PM2,5", 127, M2),
  {_, Val1} = pollution:getCorrelation(pm10, "PM2,5", M3),
...
getCorrelationOneListEmptyError_test() ->
  ...
  M = pollution:createMonitor(),
  {_, M1} = pollution:addStation("Cintra", {55.5, 77.7}, M),
  {_, M2} = pollution:addValue("Cintra", {{2019, 5, 1}, {19, 11, 10}}, "PM10", 125, M1),
  {_, M3} = pollution:addValue("Cintra", {{2019, 5, 1}, {19, 11, 11}}, "PM10", 127, M2),
  {_, Val1} = pollution:getCorrelation("PM10", "PM2,5", M3),
  ?assertEqual(ExpectedValue, Val1).